...
public class RichTextEditor extends ScrollView {
    ...
    private int rtTextColor = Color.parseColor("#000000");
	...
	public RichTextEditor(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		rtTextColor = ta.getColor(R.styleable.RichTextEditor_rt_editor_text_color, Color.parseColor("#000000"));
...
//				.start(activity);
	...
	public void addEditTextAtIndex(final int index, CharSequence editStr) {
		try {
			EditText editText2 = createEditText("请输入描述", EDIT_PADDING);
